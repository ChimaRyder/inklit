...
<div>
    <div class="w-full min-h-fit p-8 bg-gray-100 rounded-lg flex flex-col gap-4">
                ...
                @if($post->user_id === auth()->user()->id)
                    <div class="dropdown dropdown-bottom dropdown-end">
                        ...
                        <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm">
                            <li><p><x-fas-edit class="w-4 h-4"/> Edit</p></li>
                            <li><p><x-fas-trash-can class="w-4 h-4"/> Delete</p></li>
                        </ul>
                    </div>
                @endif
            @endif
